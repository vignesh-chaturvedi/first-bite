...
const ERRORS: Record<string, string> = {
  ...
  PREPARATION_DISABLED: 'New registrations are paused. You can check an existing registration or explore the walkthrough.',
  EXECUTION_DISABLED: 'Wallet approvals are paused. Check saved progress or contact your organizer.',
  ...
  rejected: 'Nightly did not return an approval. Check any message in the wallet before trying again. Nothing new was submitted from this screen.',
