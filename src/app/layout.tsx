...
export const metadata: Metadata = {
  ...
  description: 'An invitation to Cookie, with your first .cook name and network fees covered by a sponsor. Pilot preview.',
  ...
  return <html lang="en"><body className="font-sans antialiased">
    ...
    <header className="page-width flex min-h-24 flex-wrap items-center justify-between gap-4 py-5">
      ...
      <nav aria-label="Main navigation" className="flex items-center gap-5 text-sm sm:gap-8">
        ...
        <span className="rounded-full border border-border px-3 py-1.5 text-xs font-medium text-muted-foreground">Pilot preview</span>
      </nav>
    </header>
    {children}
